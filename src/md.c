...
#define F(x, y, z) (((x) & (y)) | (~(x) & (z))) // F function (4.1)
#define G(x, y, z) (((x) & (z)) | ((y) & ~(z))) // G function (4.2)
#define H(x, y, z) ((x) ^ (y) ^ (z))            // H function (4.3)
#define I(x, y, z) ((y) ^ ((x) | ~(z)))         // I function (4.4)

#define MD5_HASH_STEP0(t, s, k)                                        \
	T = a + F(b, c, d) + k + ((uint32_t*)(m + i * 64))[t];             \
	a = d;                                                             \
	d = c;                                                             \
	c = b;                                                             \
	b += ROTL32(T, s);
...
#define MD5_HASH_STEP1(t, s, k)                                        \
	T = a + G(b, c, d) + k + ((uint32_t*)(m + i * 64))[(5*t+1) & 0xF]; \
	a = d;                                                             \
	d = c;                                                             \
	c = b;                                                             \
	b += ROTL32(T, s);
...
#define MD5_HASH_STEP2(t, s, k)                                        \
	T = a + H(b, c, d) + k + ((uint32_t*)(m + i * 64))[(3*t+5) & 0xF]; \
	a = d;                                                             \
	d = c;                                                             \
	c = b;                                                             \
	b += ROTL32(T, s);
...
#define MD5_HASH_STEP3(t, s, k)                                        \
	T = a + I(b, c, d) + k + ((uint32_t*)(m + i * 64))[(7*t) & 0xF];   \
	a = d;                                                             \
	d = c;                                                             \
	c = b;                                                             \
	b += ROTL32(T, s);
